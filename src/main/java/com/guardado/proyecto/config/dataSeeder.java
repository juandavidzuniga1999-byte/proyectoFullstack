...
public class dataSeeder {
    ...
    public CommandLineRunner sembrarDatos(propiedadRepository repo) {
        return args -> {
            ...
            p1.setDescripcion("Amplia casa en Fracc. Villas de Altamira, ideal para familia. Cuenta con acabados de calidad, buena iluminación natural y cercanía a escuelas y comercios.");
            repo.save(p1);
            ...
            p2.setPrecio(767880);
            p2.setDescripcion("Propiedad en remate hipotecario, excelente oportunidad de inversión en la Col. Tamaulipas.");
            repo.save(p2);
            ...
            p3.setPrecio(750000);
            p3.setDescripcion("Casa en proceso de escrituración en Fracc. Santa Elena, terreno amplio con potencial de ampliación.");
            repo.save(p3);
                        }
                    };
                }
